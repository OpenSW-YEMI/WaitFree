    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('notifications')
            .where('userId',
                isEqualTo: currentUser.uid) // 현재 사용자 ID에 맞는 알림만 가져옴
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: 0.0, horizontal: 11.0),
                  child: Column(
                    children: [
                      const SizedBox(height: 16),
                      Row(
                        mainAxisAlignment:
                            MainAxisAlignment.spaceBetween, // 왼쪽 정렬
                        children: [
                          Column(
                            crossAxisAlignment:
                          ...
                          trailing: timestamp != null
                              ? Column(
                                  ...
                                  mainAxisAlignment: MainAxisAlignment
                                      .center, // Column 내부 요소를 수직으로 중앙 정렬
                                  children: [
                                    // 날짜 부분
                                    Text(
